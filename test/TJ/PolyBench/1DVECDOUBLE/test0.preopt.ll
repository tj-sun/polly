; ModuleID = 'VecDouble.spir.ll'
source_filename = "VecDouble.spir"
target datalayout = "e-i64:64-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "spir64-unknown-unknown"

; Function Attrs: nounwind
define spir_kernel void @Convolution2D_kernel(float addrspace(1)* nocapture %A, float addrspace(1)* nocapture readonly %B, i32 %ni, i32 %nj) #0 {
  br label %.split
...
!0 = !{void (float addrspace(1)*, float addrspace(1)*, i32, i32)* @Convolution2D_kernel, !1, !2, !3, !4, !5}
